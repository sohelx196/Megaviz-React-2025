    ...
    <>
      ...
      <section className="my-7">
        ...
        <div className="relative hidden sm:flex justify-center items-center px-4 md:px-0">
          ...
          <img
            src={studentImg}
            alt="Team Meeting Desktop"
            className="rounded-2xl w-full max-w-3xl object-cover z-10"
            loading="lazy"
          />
          ...
          <div className="absolute bottom-6 right-48 bg-white rounded-xl shadow-lg px-4 py-4 w-60 z-20">
            ...
            <p className="font-nunito text-sm text-gray-600  leading-tight">
              “ Our team of professional engineers offer innovative solutions
              for all your IT requirements. We pride ourselves in providing the
              most cost effective and high performance IT solutions that not
        ...
        <div className="max-w-7xl mx-auto space-y-12 bg-[#F9F9F9] px-4 py-12 sm:px-8 sm:py-16 lg:p-20">
          ...
          <div className="flex flex-col lg:flex-row items-start gap-4 lg:gap-8 px-4">
            ...
            <p className="font-cabin text-base sm:text-lg text-[#878C91] leading-relaxed text-left sm:text-justify lg:text-left max-w-screen-md mx-auto px-4 sm:px-6 lg:px-0">
              Mega Vision Computers Trading LLC is a leading Enterprise IT
              solutions provider head quartered in Dubai and servicing the IT
              requirements of companies in UAE and the wider GCC region. We
              offer end to end IT solutions and services ranging from simple
              supply and installation of basic Hardware / Software /
              Surveillance / Access Control systems to configuration and
              maintenance of large Enterprise Servers and Security Firewall
              networks.
            </p>
          </div>
            ...
            <div className="lg:col-span-2 relative text-white rounded-2xl shadow-lg min-h-[250px] overflow-hidden flex flex-col justify-between p-6 bg-black">
              ...
              <div className="absolute inset-0 z-0">
                <img
                  src={projectFinish}
                  alt="Project Finish"
                  className="w-full h-full object-cover opacity-3 rotate-[6deg] scale-110"
                  loading="lazy"
                />
              </div>
              ...
              <div className="relative z-10">
                <h3 className="font-jakarta text-4xl sm:text-5xl md:text-6xl lg:text-[65px] font-bold leading-tight">
                  1,472
                  <span className="text-[#C72C28] text-xl sm:text-2xl md:text-3xl lg:text-6xl font-extrabold">
                    +
                  </span>
                </h3>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 sm:gap-5">
          ...
          <div className="hover:shadow-lg hover:shadow-black transition-all duration-500 cursor-pointer bg-[#EBE2F2] rounded-xl p-6 sm:p-8 flex flex-col justify-start items-center shadow-md max-w-md mx-auto">
            ...
            <div className="w-full">
              ...
              <p className="font-cabin text-[#323131] text-sm sm:text-base md:text-[17px] leading-relaxed sm:leading-[1.8rem] max-w-prose ">
                To Give Inventive, High Calibre And Top Tier IT Consulting & IT
                Solutions & Services To Our Clients, Empowering Them To
                Accomplish Their Business Destinations. Partners And Accomplices
                While Co-Operating. Also, To Keep Up And Grow Our Convention Of
                "Greatness Through Quality".
              </p>
            </div>
          </div>
        </div>
